...
1. Open Microsoft Edge (if it’s not already open), then open a new tab. Copy the link **below** and paste it into the address bar to access the **Microsoft Foundry portal**:
