...
1. Open Microsoft Edge (if not already open). If it is open</inject>, just open a new tab. Then paste the **link below** into the address bar to access the **Microsoft Foundry portal**:
...
1. Open a new browser tab and download Expenses_policy.docx using the **link below**. This document contains the expense policy details for the fictional Contoso corporation.
